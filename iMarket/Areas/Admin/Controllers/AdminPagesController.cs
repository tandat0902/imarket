...
namespace iMarket.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public AdminPagesController(iMarketDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Thumbnail,Published,Title,MetaDesc,MetaKey,Alias,CreatedAt,Ordering")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PageId,PageName,Contents,Thumbnail,Published,Title,MetaDesc,MetaKey,Alias,CreatedAt,Ordering")] Page page)
        {
            if (id != page.PageId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'iMarketDBContext.Pages'  is null.");
            }
            var page = await _context.Pages.FindAsync(id);
            if (page != null)
            {
